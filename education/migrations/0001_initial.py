...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # many-to-many через промежуточную модель добавляется после создания этой модели
        migrations.AddField(
            model_name='discipline',
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='disciplines', through='education.DisciplineGroup', through_fields=('discipline', 'group'), to='education.academicgroup', verbose_name='Учебные группы'),
        ),
        migrations.CreateModel(
            name='AnswerOption',
            fields=[
        ...
        migrations.AddField(
            model_name='test',
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='tests', through='education.TestGroup', through_fields=('test', 'group'), to='education.academicgroup', verbose_name='Доступные группы'),
        ),
        migrations.AddField(
            model_name='question',
            name='test',
